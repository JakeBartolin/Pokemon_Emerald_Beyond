static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_SEVII_ISLAND_ONE_ISLAND - 1] = {MAP_GROUP(SEVII_ISLAND_ONE_ISLAND), MAP_NUM(SEVII_ISLAND_ONE_ISLAND), 13, 10},
    [HEAL_LOCATION_SEVII_ISLAND_EIGHT_ISLAND - 1] = {MAP_GROUP(SEVII_ISLAND_EIGHT_ISLAND), MAP_NUM(SEVII_ISLAND_EIGHT_ISLAND), 10, 10},
};
